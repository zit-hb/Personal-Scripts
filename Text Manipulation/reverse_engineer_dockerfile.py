...
def main() -> None:
    ...
    if args.provider == "anthropic":
        ...
        if args.model == "gpt-4o-mini":  # Default OpenAI model
            args.model = "claude-3-haiku-20240307"  # Default Anthropic model
    else:  # openai
    ...
    logging.info(f"Sending request to {args.provider} model: {args.model}")
    dockerfile_content = provider.generate_response(conversation, args.model)
